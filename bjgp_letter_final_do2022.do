...
label define no_of_pts_cut_tens 0"1000 to 9,999" 10"10,000 to 19,999" 20"20,000 to 29,999" 30"30,000 to 39,999" 40"40,000 to 49,999" 50"50,000 to 59,999" 60">=60,000", replace
...
import delimited "8. General Practice – December 2021 Practice Level"
...
tabodds q18_12 no_of_pts_cut_tens if no_of_pts_thous <60 , bin(q18base) graph ci yscale(log) addplot(line linear_fit_odds no_of_pts_cut_tens if no_of_pts_thous <60, sort)
...
*tabodds but adding the linear fit line
tabodds q28_12 no_of_pts_cut_tens if no_of_pts_thous <60 , bin(q28base) graph ci yscale(log) addplot(line linear_fit_odds2 no_of_pts_cut_tens if no_of_pts_thous <60, sort)
